/*
    ...
    Açıklama        : Nu çalışma eğitim amaçlı olarak öğrencilere yaptırmak amacıyla tasarlanmıştır. İnsan hayatını etkilyecek yerlerde kullanmak yasaktır.
                      ...
                      Devre Arduino + NTC sensörü kullanılarak tasarlanmıştır. Butonlar yardımıyla set değeri ve tolerans ayarlanarak istenilen sıcaklık
                      değerinde ve istenilen tolerans aralığında kontrol sağlanabilir. NTC ile 1 derece hassasiyetle ölçüm yapılabilr. Devre şeması ve
...
#define BUTON_ARTI              15  //Artı butonunun bağlantı pini
#define BUTON_EKSI              16  //Eksi butonunun bağlantı pini
...
#define CA2                     11  //2.Göstergenin Anodu/Katodu
#define CA3                     10  //3.Göstergenin Anodu/Katodu
#define CA4                     12  //4.Göstergenin Anodu/Katodu
...
void setup()
{
    ...
    if(sistem.eepIlkCalisma > 1){       //Eğer ilk çalışma ise değerleri kur
        ...
        sistem.eepDereceSet = 25;
        sistem.eepTolerans = 1;
...
void gostergeYaz()
{
    ...
    switch (gostergeModu)
    {
    case GOSTERGE_MODU_DERECE:      //Ekranda dereceyi gösterir
        gostergeData = derece;
        gosterge.gostergeGuncelle(gostergeData, ONDALIK_YOK, DERECE, SONA_EKLE);
        break;
    case GOSTERGE_MODU_SET:         //Göstergede Derece Set değerini gösterir
        gostergeData = dereceSet;
        gosterge.gostergeGuncelle(gostergeData, ONDALIK_YOK, C, BASA_EKLE);
        break;
    case GOSTERGE_MODU_TOLERANS:    //Göstergede Tolerabs değerini gösterir
        gostergeData = tolerans;
        gosterge.gostergeGuncelle(gostergeData, ONDALIK_YOK, T, BASA_EKLE);
        break;
    default:
        break;
    }
...
int dereceOlc()
{
    ...
    return pgm_read_word_near(&ntcLookupTable[adc]);
}
